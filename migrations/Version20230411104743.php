 ...
 */
<<<<<<<< HEAD:migrations/Version20230414111455.php
final class Version20230414111455 extends AbstractMigration
========
final class Version20230411104743 extends AbstractMigration
>>>>>>>> 9e2aded4bf8a719569da6af30f39c5ee0ab1f165:migrations/Version20230411104743.php
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE categories_offers (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE localities_offers (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE offers (id INT AUTO_INCREMENT NOT NULL, company_id INT NOT NULL, modality_id INT NOT NULL, category_id INT NOT NULL, locality_id INT NOT NULL, weekly_hours_id INT NOT NULL, title VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, positions INT NOT NULL, activated TINYINT(1) NOT NULL, activated_by_admin TINYINT(1) NOT NULL, creation_date DATETIME NOT NULL, updated_date DATETIME NOT NULL, INDEX IDX_DA460427979B1AD6 (company_id), INDEX IDX_DA4604272D6D889B (modality_id), INDEX IDX_DA46042712469DE2 (category_id), INDEX IDX_DA46042788823A92 (locality_id), INDEX IDX_DA460427B31209DB (weekly_hours_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user_to_offer (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, offer_id INT NOT NULL, date DATETIME NOT NULL, INDEX IDX_C267520EA76ED395 (user_id), INDEX IDX_C267520E53C674EE (offer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE weekly_hours_offers (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE offers ADD CONSTRAINT FK_DA46042712469DE2 FOREIGN KEY (category_id) REFERENCES categories_offers (id)');
        $this->addSql('ALTER TABLE offers ADD CONSTRAINT FK_DA46042788823A92 FOREIGN KEY (locality_id) REFERENCES localities_offers (id)');
        $this->addSql('ALTER TABLE offers ADD CONSTRAINT FK_DA460427B31209DB FOREIGN KEY (weekly_hours_id) REFERENCES weekly_hours_offers (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE offers DROP FOREIGN KEY FK_DA46042788823A92');
        $this->addSql('ALTER TABLE offers DROP FOREIGN KEY FK_DA460427B31209DB');
        ...
        $this->addSql('DROP TABLE categories_offers');
        $this->addSql('DROP TABLE company');
        $this->addSql('DROP TABLE company_type');
        $this->addSql('DROP TABLE localities_offers');
        ...
        $this->addSql('DROP TABLE weekly_hours_offers');
