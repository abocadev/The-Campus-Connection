 ...
 */
class getTypeOffersRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TypeOffersRepository' shared autowired service.
     *
     * @return \App\Repository\TypeOffersRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TypeOffersRepository.php';

        return $container->privates['App\\Repository\\TypeOffersRepository'] = new \App\Repository\TypeOffersRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
