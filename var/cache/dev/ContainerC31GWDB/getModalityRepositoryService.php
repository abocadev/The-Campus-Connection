 ...
 */
class getModalityRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ModalityRepository' shared autowired service.
     *
     * @return \App\Repository\ModalityRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ModalityRepository.php';

        return $container->privates['App\\Repository\\ModalityRepository'] = new \App\Repository\ModalityRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
