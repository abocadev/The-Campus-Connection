 ...
 */
class getUserCompanyRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\UserCompanyRepository' shared autowired service.
     *
     * @return \App\Repository\UserCompanyRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'UserCompanyRepository.php';

        return $container->privates['App\\Repository\\UserCompanyRepository'] = new \App\Repository\UserCompanyRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
