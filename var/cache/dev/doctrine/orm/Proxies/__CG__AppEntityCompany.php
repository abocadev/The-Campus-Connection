...
class Company extends \App\Entity\Company implements \Doctrine\Persistence\Proxy
{
    ...
    private const LAZY_OBJECT_PROPERTY_SCOPES = [
        "\0".parent::class."\0".'CompanyTypeID' => [parent::class, 'CompanyTypeID', null],
        ...
        "\0".parent::class."\0".'url_web' => [parent::class, 'url_web', null],
        'CompanyTypeID' => [parent::class, 'CompanyTypeID', null],
        'description' => [parent::class, 'description', null],
        'id' => [parent::class, 'id', null],
        'location' => [parent::class, 'location', null],
        'name' => [parent::class, 'name', null],
        'url_image' => [parent::class, 'url_image', null],
        'url_web' => [parent::class, 'url_web', null],
    ];
