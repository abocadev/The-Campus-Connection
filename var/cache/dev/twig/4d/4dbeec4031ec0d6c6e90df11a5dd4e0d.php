...
class __TwigTemplate_193d64a7443b7a2076fdb4198d4f33af extends Template
{
    private $source;
    private $macros = [];
    ...
    {% block body %}
        ...
        <form action=\"{{ path('app_login') }}\" method=\"post\">
            ...
            <input type=\"hidden\" name=\"_target_path\" value=\"/registration\"> #}

            <button type=\"submit\">login</button>
        </form>
    {% endblock %}", "auth/login/index.html.twig", "C:\\Users\\Albert Bocanegra\\Documents\\GitHub\\The-Campus-Connection\\templates\\auth\\login\\index.html.twig");
    }
}
