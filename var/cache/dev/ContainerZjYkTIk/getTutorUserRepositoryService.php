 ...
 */
class getTutorUserRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\TutorUserRepository' shared autowired service.
     *
     * @return \App\Repository\TutorUserRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'TutorUserRepository.php';

        return $container->privates['App\\Repository\\TutorUserRepository'] = new \App\Repository\TutorUserRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
